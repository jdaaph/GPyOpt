...
import numpy as np
import time
from ..acquisitions import AcquisitionEI, AcquisitionMPI, AcquisitionLCB, AcquisitionEI_MCMC, AcquisitionMPI_MCMC, AcquisitionLCB_MCMC, AcquisitionLP, AcquisitionBinaryT
...
class BayesianOptimization(BO):
    ...
    def _acquisition_chooser(self):
        ...
        elif self.acquisition_type =='BinaryT':
            return AcquisitionBinaryT(self.model, self.space, self.acquisition_optimizer, self.cost.cost_withGradients, self.acquisition_jitter)
